...
// C
// C     x_end       FINAL X-VALUE (XEND-X MAY BE POSITIVE OR NEGATIVE)
// C
...
// C
// C     r_tol,a_tol RELATIVE AND ABSOLUTE ERROR TOLERANCES. THEY
// C                 CAN BE BOTH SCALARS OR ELSE BOTH VECTORS OF LENGTH N.
// C
// C     i-tol       SWITCH FOR RTOL AND ATOL:
...
// C
// C     i_jac       SWITCH FOR THE COMPUTATION OF THE JACOBIAN:
...
// C
// C     ml_jac      SWITCH FOR THE BANDED STRUCTURE OF THE JACOBIAN:
// C                    MLJAC=N: JACOBIAN IS A FULL MATRIX. THE LINEAR
// C                       ALGEBRA IS DONE BY FULL-MATRIX GAUSS-ELIMINATION.
// C                    0<=ml_jac<N: ml_jac IS THE LOWER BANDWITH OF JACOBIAN
// C                       MATRIX (>= NUMBER OF NON-ZERO DIAGONALS BELOW
// C                       THE MAIN DIAGONAL).
// C
// C     mu_jac      UPPER BANDWITH OF JACOBIAN  MATRIX (>= NUMBER OF NON-
...
// C
// C     i_mas       GIVES INFORMATION ON THE MASS-MATRIX:
// C                    IMAS=0: M IS SUPPOSED TO BE THE IDENTITY
// C                       MATRIX, MAS IS NEVER CALLED.
// C                    IMAS=1: MASS-MATRIX  IS SUPPLIED.
// C
// C     ml_mas      SWITCH FOR THE BANDED STRUCTURE OF THE MASS-MATRIX:
...
// C
// C     mu_mas      UPPER BANDWITH OF MASS-MATRIX (>= NUMBER OF NON-
// C                 ZERO DIAGONALS ABOVE THE MAIN DIAGONAL).
// C                 NEED NOT BE DEFINED IF MLMAS=N.
// C                 MUMAS IS SUPPOSED TO BE .LE. MUJAC.
// C
// C     sol_out     NAME (EXTERNAL) OF SUBROUTINE PROVIDING THE
...
// C
// C     i_out       SWITCH FOR CALLING THE SUBROUTINE SOLOUT:
...
// C
// C     l_work      DECLARED LENGTH OF ARRAY "WORK".
// C
// C     i_work      INTEGER WORKING SPACE OF LENGTH "LIWORK".
...
// C
// C     li_work     DECLARED LENGTH OF ARRAY "IWORK".
// C
// C     r_par, i_par
// C                 REAL AND INTEGER PARAMETERS (OR PARAMETER ARRAYS) WHICH
...
// C
// C     id_id       REPORTS ON SUCCESSFULNESS UPON RETURN:
...
// C
// C   IWORK(14)  n_fcn   NUMBER OF FUNCTION EVALUATIONS (THOSE FOR NUMERICAL
// C                      EVALUATION OF THE JACOBIAN ARE NOT COUNTED)
// C   IWORK(15)  n_jac   NUMBER OF JACOBIAN EVALUATIONS (EITHER ANALYTICALLY
// C                      OR NUMERICALLY)
// C   IWORK(16)  n_step  NUMBER OF COMPUTED STEPS
// C   IWORK(17)  n_accpt NUMBER OF ACCEPTED STEPS
// C   IWORK(18)  n_rejct NUMBER OF REJECTED STEPS (DUE TO ERROR TEST),
// C                      (STEP REJECTIONS IN THE FIRST STEP ARE NOT COUNTED)
// C   IWORK(19)  n_dec   NUMBER OF LU-DECOMPOSITIONS OF BOTH MATRICES
// C   IWORK(20)  n_sol   NUMBER OF FORWARD-BACKWARD SUBSTITUTIONS, OF BOTH
